...
import { PrismicQueries } from 'utils/prismic/queries'
export default function Home({ data }) {
  return (
    <>
      <Page
        seo={{
          title: 'Powered by Vercel | Made by tak',
        }}
        footer={
          <Flex as="footer" py={4}>
            <Container
            ...
            >
              ...
              >
                Powered by{' '}
                <div style={{ height: '1rem', marginLeft: '0.3rem' }}>
                  <svg
                    height="100%"
                    viewBox="0 0 284 65"
                    fill="#000"
...
export async function getServerSideProps({
  ...
  const document = await client(req).getByUID('page', 'home', {
    graphQuery: `{${PrismicQueries.page}}`,
  })
